...
<details>
<summary>Questin’ wif woosa</summary>
...
![Aura of the Beholder upgrade](aura-upgrade.png "Aura of the Beholder upgrade")
...
![Have you really defeated the Horntail?](have-you-really-defeated-the-horntail.png "Have you really defeated the Horntail?")
...
![Protect Tylus!](protect-tylus.png "Protect Tylus!")
...
![Ice Sentinel card get!](rusa-ice-sentinel-card-get.png "Ice Sentinel card get!")
...
![rusa enters ENPQ](rusa-enters-enpq.png "rusa enters ENPQ")
...
![You have failed to protect Tylus](you-have-failed-to-protect-tylus.png "You have failed to protect Tylus")
...
![cervid gets Infinity](cervid-gets-infinity.png "cervid gets Infinity")

And with that, I headed to deep loodi to do the Papu prequests:

![Buffy card get!](rusa-buffy-card-get.png "Buffy card get!")

![Master Death Teddy card get!](rusa-master-death-teddy-card-get.png "Master Death Teddy card get!")
...
![rusa vs. GPWs](rusa-vs-gpws.png "rusa vs. GPWs")

And, now that I had goofed on the pocket watches hard enough to get the crack pieces A, B, and C, I was ready to fight Papu~!

![rusa finishes the Papulatus prequests~](rusa-finishes-pap-prequests.png "rusa finishes the Papulatus prequests~")
...
![cervine & Level1Crook @ CDs](cervine-and-crook-at-cds.png "cervine & Level1Crook @ CDs")
...
![Puff Dad claims another life](puff-dad-claims-another-life.png "Puff Dad claims another life")
...
![cervine w/ claw](cervine-with-claw.png "cervine w/ claw")
...
<details>
<summary>Papu preqs wiff cervidddd</summary>
...
![Buffy card get!](buffy-card-get.png "Buffy card get!")
...
![cervid vs. MDTs](cervid-vs-mdts.png "cervid vs. MDTs")

And this was even _more_ apparent when it came to fighting the Goofy Pocket Watches:

![cervid vs. GPWs](cervid-vs-gpws.png "cervid vs. GPWs")
...
![cervid finishes the Papu prequests~](cervid-finishes-the-pap-prequests.png "cervid finishes the Papu prequests~")
...
![Mossy Snail card get!](sorts-mossy-giant-snail-card-get.png "Mossy Snail card get!")
...
![Stone Bug card get!](sorts-stone-bug-card-get.png "Stone Bug card get!")

![Tree Rod card get!](sorts-tree-rod-card-get.png "Tree Rod card get!")
...
![sorts vs. Mossy Mushroom](sorts-vs-mossy-mushroom.png "sorts vs. Mossy Mushroom")
...
![Rocky Mountain Cave entrance](rocky-mountain-cave-entrance.png "Rocky Mountain Cave entrance")
...
![Violent Primitive Boars hit hard](violent-primitive-boars-hit-hard.png "Violent Primitive Boars hit hard")
...
![Cerebellum vs. Violent Primitive Boar](cerebellum-vs-violent-primitive-boars.png "Cerebellum vs. Violent Primitive Boar")
...
![rusa vs. Violent Primitive Boar](rusa-vs-violent-primitive-boar.png "rusa vs. Violent Primitive Boar")
...
![Primitive Boar card get!](sorts-primitive-boar-card-get.png "Primitive Boar card get!")

And sorts now has her Ellin ring ^^

![sorts acquires the Ellin ring~!](sorts-acquires-the-ellin-ring.png "sorts acquires the Ellin ring~!")
