...
The core mechanic of pugilists — indeed, their *raison d’être* — is the fact that pirates (first job and onwards) can attack 🚫without any weapons🚫 equipped. Naturally, this suggests the question: but how tho? The answer, of course, is punching 👊🏾. And kicking 🦵🏾. You know, [unarmed](https://en.wikipedia.org/wiki/Subak) [martial arts](https://en.wikipedia.org/wiki/Taekkyon) [and shit](https://en.wikipedia.org/wiki/Taekwondo). But how *much* tho?
