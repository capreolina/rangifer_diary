...
<details>
<summary>Victorious Island</summary>

![Stucc in the APQ entrance…](stucc-in-apq-entrance.webp "Stucc in the APQ entrance…")
...
![The actual worst possible Fitness event](the-actual-worst-fitness.webp "The actual worst possible Fitness event")

A participant by the name of <b>GenjiDeflect</b> aptly summed up the experience:

![this is the worst thing i’ve ever done](this-is-the-worst-thing-i-ve-ever-done.webp "this is the worst thing i’ve ever done")
...
![The winners of the actual worst possible Fitness event](the-actual-worst-fitness-winners.webp "The winners of the actual worst possible Fitness event")
...
![d34r hits level 84~!!](d34r-84.webp "d34r hits level 84~!!")
...
![d33r @ Ola Ola](d33r-ola-ola.webp "d33r @ Ola Ola")
...
![d33r pulls a cape STR 30% from SoS](d33r-pulls-cape-str-30-from-sos.webp "d33r pulls a cape STR 30% from SoS")
...
![d33r vs. Lorangs &amp; Clangs](d33r-vs-lorangs-and-clangs.webp "d33r vs. Lorangs &amp; Clangs")
...
![Tortie card get!](d33r-tortie-card-get.webp "Tortie card get!")
...
![d33r finished the King Clang prequests!](d33r-finished-king-clang-prequests.webp "d33r finished the King Clang prequests!")
...
![d33r vs. King Clang](d33r-vs-king-clang.webp "d33r vs. King Clang")
...
![trishaa &amp; d34r vs. Grog](trishaa-and-d34r-vs-grog.webp "trishaa &amp; d34r vs. Grog")
...
![Pre-celebrating `131`](pre-celebrating-131.webp "Pre-celebrating `131`")
...
![d34r &amp; Vicloc @ MM’s house](d34r-and-vicloc-at-mm-s-house.webp "d34r &amp; Vicloc @ MM’s house")
...
![d33r vs. Ice Drakes](d33r-vs-ice-drakes.webp "d33r vs. Ice Drakes")

And again, to my surprise, I actually managed to produce a card, even at the rate that I was killing these things o\_o

![Ice Drake card get!](d33r-ice-drake-card-get.webp "Ice Drake card get!")
...
![d33r hits level 65~!](d33r-65.webp "d33r hits level 65~!")
...
![d34r finally finishes her shield…](d34r-s-shield.webp "d34r finally finishes her shield…")
...
<details>
<summary>Footnotes for “rusa busca tarjetas”</summary>
...
![capre &amp; Harlez vs. Ravana](capre-and-harlez-vs-rav.webp "capre &amp; Harlez vs. Ravana")
...
![Evil Dead setup fail…](evil-dead-setup-fail.webp "Evil Dead setup fail…")
...
![potpan helping uayua w/ MPQ](potpan-helping-uayua-with-mpq.webp "potpan helping uayua w/ MPQ")
...
<details>
<summary>トウキョウ（未来）</summary>

![rusa, Harlez, &amp; Sagie sign for Bergamot](rusa-harlez-and-sagie-sign-for-berga.webp "rusa, Harlez, &amp; Sagie sign for Bergamot")

To summon the beast, one must first kill this annoying flying robot thingy:

![Summoning Berga](summoning-berga.webp "Summoning Berga")

And there it is, in all of its ugly glory!!:

![rusa, Harlez, &amp; Sagie vs. Berga](rusa-harlez-and-sagie-vs-berga.webp "rusa, Harlez, &amp; Sagie vs. Berga")

Berga has three bodies; as it transitions from one body to the next, it loses some part of its structure. From body one to body two, it loses its [rotary autocannon](https://en.wikipedia.org/wiki/Rotary_cannon). From body two to body three, it loses its [laser weapon](https://en.wikipedia.org/wiki/Laser_weapon). Although this suggests that its third body may be the weakest, it doesn’t quite pan out that way. Although the first body is definitely the “strongest” in terms of how much punishment it can take, the first body also doesn’t try that hard to kill you (although it definitely still can kill you…). The real punishment comes with the third and final body, where Berga loses its laser weaponry, but gains a new cannon on the front of its body that hits quite hard (&ap;14[k](https://en.wikipedia.org/wiki/Kilo-) damage to an unarmed &amp; unarmoured target) and stuns. What’s worse, you now have no choice but to dodge the missiles that Berga has been shooting this whole time, because not only do they hit harder now (&ap;12k damage to an unarmed &amp; unarmoured target), but they seduce you!!! The seduce <del>appears to always be a jump sed</del> is always a left-jump sed (forcing the victim to walk leftwards, jump repeatedly, and do nothing else, not even eat potions/food!), and thus tends to cause [PC](https://en.wikipedia.org/wiki/Player_character)s to jump at the top-left corner of the map. This is because <del>the attack _also_ knocks back, thus naturally imparting a leftward [momentum](https://en.wikipedia.org/wiki/Momentum) on the victim, and because</del> the bottom of the map (where you can actually attack Berga) is actually water, so a few jumps yeets you high up into the air:

![Jump sed @ Bergamot](jump-sed.webp "Jump sed @ Bergamot")

Berga also has the ability to stun, and even to briefly stun sed! Stun sed is a bit unusual, as it _sort of_ works like other types of seduce, except that you don’t move at all, and it’s invisible as well! That’s right: no seduce icon above your head, and not even a chat message saying “You have been seduced, \[…\]”. Getting stunned or stun sed can be pretty deadly, as it prevents your ability to dodge the falling explosive missiles that do the left-jump sed. <del>Of course, the knockback from the missile attack can be thwarted by</del> For reasons that I only poorly understand, [Power Stance](https://maplelegends.com/lib/skill?id=1321002) <del>which causes the seduce victim to remain in range of Berga’s attacks while they are seduced</del> is a bad idea for the third body of Berga, as it appears to interact dangerously with Berga. <del>Worse is if you get seduced and stunned at the same time…</del>

So, needless to say, I died.

![rusa dies to Berga…](rusa-dies-to-berga.webp "rusa dies to Berga…")

Owie.

We tried again, aided by corsair <b>danicuwu</b> and buccaneer <b>KaLin</b>:

![Running Berga, now bolstered by danicuwu &amp; KaLin](berga-bolstered-by-danicuwu-and-kalin.webp "Running Berga, now bolstered by danicuwu &amp; KaLin")

…Aaaand I still died:

![Aaaand I still died.](i-still-died.webp "Aaaand I still died.")
...
![Prototype Lord card get!](rusa-protoroad-card-get.webp "Prototype Lord card get!")
...
![Twisted Radar get!](rusa-radar-get.webp "Twisted Radar get!")
...
![Finishing NTPQ for the first time](finishing-ntpq-for-the-first-time.webp "Finishing NTPQ for the first time")
...
![Akihabara](akihabara.webp "Akihabara")
...
![rusa @ Iruwatas](rusa-at-eruwaters.webp "rusa @ Iruwatas")
...
![Getting stuck in the Iruwatas map](getting-stuck-in-eruwaters-map.webp "Getting stuck in the Iruwatas map")
...
![Monke gets stuck in the Iruwatas map](monke-gets-stuck-in-eruwaters-map.webp "Monke gets stuck in the Iruwatas map")
...
![Iruwata Transmitter get!](rusa-eruwater-transmitter-get.webp "Iruwata Transmitter get!")
...
![Ye olde Kerning City MRT car, in Neo Tokyo](ye-olde-kerning-city-mrt-car-in-neo-tokyo.webp "Ye olde Kerning City MRT car, in Neo Tokyo")
...
![ToasTea, Sagie, Harlez, &amp; rusa, ready to Dunas!](toastea-sagie-harlez-and-rusa-ready-to-dunas.webp "ToasTea, Sagie, Harlez, &amp; rusa, ready to Dunas!")

Here’s a pretty good shot of what a Dunas fight looks like:

![ToasTea, Sagie, Harlez, &amp; rusa vs. Dunas](toastea-sagie-harlez-and-rusa-vs-dunas.webp "ToasTea, Sagie, Harlez, &amp; rusa vs. Dunas")

Dunas’s main gimmick is that they’re capable of DRing (damage reflecting). Nominally, this ability does what it says on the tin: if you attack a monster that is DR’d, you don’t damage the monster, but rather get the damage that you _would_ have done to the monster reflected back at yourself. This kills the PC. We will later see why this isn’t an accurate characterisation of DR, but for now it’s good enough. You do get some warning: when Dunas casts DR, they appear to merely be weapon-cancelled at first: all physical attacks deal damage lines that are either “<b>1</b>”s or “<b>MISS</b>”es, but the actual damage _reflection_ isn’t active for another &ap;1 second or so. Without this grace period, DR would certainly be unfair; besides the obvious [reaction time](https://en.wikipedia.org/wiki/Mental_chronometry) necessary, it still remains that many attacking animations in the game commit the PC to attacking long after the player has actually given [input](https://en.wikipedia.org/wiki/Input_device). In any case, what this effectively amounts to is: “if you start seeing ‘<b>1</b>’s, _stop attacking_”.
...
![Dying to Dunas…](dying-to-dunas.webp "Dying to Dunas…")
...
![Harlez streaming a solo Dunas run…](harlez-stream-soloing-dunas.webp "Harlez streaming a solo Dunas run…")

Eventually, Harlez successfully finished the solo Dunas run! And got the chair!!!!!:

![Harlez’s solo Dunas drops](harlez-solo-dunas-chair.webp "Harlez’s solo Dunas drops")

Grats!!

Still, this wasn’t enough to get me a Dunas clear, so we tried again later, but this time as a duo with just me and Harlez:

![rusa &amp; Harlez vs. Dunas](rusa-and-harlez-vs-dunas.webp "rusa &amp; Harlez vs. Dunas")

And I died again. So we went for round two. But it didn’t work out…

![R\.I\.P. Harl ;~;](rip-harl.webp "R\.I\.P. Harl ;~;")
...
![Harlez &amp; rusa vs. Dunas, again](harlez-and-rusa-vs-dunas-again.webp "Harlez &amp; rusa vs. Dunas, again")

But it didn’t work out… and Harlez had to go to sleep…

![Harlez dies when Dunas is at 30% HP](harlez-dies-when-dunas-is-30-percent-hp.webp "Harlez dies when Dunas is at 30% HP")
...
![rusa soloing Dunas](rusa-soloing-dunas.webp "rusa soloing Dunas")
...
![rusa cowering with no ACPs](rusa-cowering-with-no-acps.webp "rusa cowering with no ACPs")
...
![My soul physically leaving my body……](my-soul-physically-leaving-my-body.webp "My soul physically leaving my body……")
...
![Dabulator, Harlez, &amp; rusa vs. Dunas](dabulator-harlez-and-rusa-vs-dunas.webp "Dabulator, Harlez, &amp; rusa vs. Dunas")
...
![Rushing Dunas](rushing-dunas.webp "Rushing Dunas")

And finally, at long last, a Dunas clear!!:

![Harlez, Dabulator, &amp; rusa kill the Dunas!!](harlez-dabulator-and-rusa-kill-the-dunas.webp "Harlez, Dabulator, &amp; rusa kill the Dunas!!")
...
![2102 Old Fox Flagship Deck](2102-old-fox-flagship-deck.webp "2102 Old Fox Flagship Deck")
...
![Dida is all grown up now](mature-dida.webp "Dida is all grown up now")
...
![NTPQ w/ Harlez &amp; ItzLeo](ntpq-with-harlez-and-itzleo.webp "NTPQ w/ Harlez &amp; ItzLeo")

After that, I did just one or two more NTPQs with Harlez, and managed to get the elusive PLG!!!:

![Got the PLG!!!](got-the-plg.webp "Got the PLG!!!")
...
<details>
<summary>Footnotes for “トウキョウ（未来）”</summary>
...
![Harlez has a keyboard malfunction](harlez-keyboard-malfunction.webp "Harlez has a keyboard malfunction")
...
![Level1Crook &amp; rusa kill the Ravana!](level1crook-and-rusa-kill-the-ravana.webp "Level1Crook &amp; rusa kill the Ravana!")
...
![tara vs. Coke™ seals](tara-vs-seals.webp "tara vs. Coke™ seals")
...
<details>
<summary>The horned tail of legend</summary>

![Selling AFK pendant to Nyotaimori](selling-afk-pendant.webp "Selling AFK pendant to Nyotaimori")
...
![rusa hits level 164~!](rusa-164.webp "rusa hits level 164~!")
...
![Is that a MW20?](is-that-a-mw20.webp "Is that a MW20?")
...
![idoybh2 gets an unexpected promotion](idoybh2-gets-an-unexpected-promotion.webp "idoybh2 gets an unexpected promotion")

Apparently, the skillbook gods once again gazed with pity upon our suffering, as we got not a MW20, but a MW40‽‽‽:

![Is that a MW40???](is-that-a-mw40.webp "Is that a MW40???")

F5

And, not to continue picking on Sagie (I love her, I swear), but she did die again as the sed target LMFAO

![R\.I\.P. sed target Sagie D:](rip-sed-target-sagie.webp "R\.I\.P. sed target Sagie D:")
...
![Is that a MW40??? Again?!?!?](is-that-a-mw40-part-2.webp "Is that a MW40??? Again?!?!?")
...
![rusa does a `@dpm 10` while cleaving left side of HT](rusa-left-side-head-cleave-dpm-10.webp "rusa does a `@dpm 10` while cleaving left side of HT")

Not bad for a pretty optimal situation, I guess :P

And not too long after, I hit level 165~!:

![rusa hits level 165~!](rusa-165.webp "rusa hits level 165~!")
...
![ht moms a hoe](ht-moms-a-hoe.webp "ht moms a hoe")
...
![Is that a MW20??? Again again?!?!?!?!?!?](is-that-a-mw20-part-2.webp "Is that a MW20??? Again again?!?!?!?!?!?")
...
![HBing oatmetal](hbing-oatmetal.webp "HBing oatmetal")
...
![Yescando was a little too quick on the draw](yescando-was-a-little-too-quick-on-the-draw.webp "Yescando was a little too quick on the draw")
...
![Is that a MW20??? Again again again…?](is-that-a-mw20-part-3.webp "Is that a MW20??? Again again again…?")
...
![rusa helping with selling HTPQ](rusa-helping-with-selling-htpq.webp "rusa helping with selling HTPQ")

We sold yet another AFK HTP service, this time to bishop <b>MiguelQc</b>:

![Selling AFK HTP to MiguelQc](selling-afk-htp-to-miguelqc.webp "Selling AFK HTP to MiguelQc")
...
![buyer jumped down](buyer-jumped-down.webp "buyer jumped down")
...
![rusa hits level 166~!](rusa-166.webp "rusa hits level 166~!")
...
![FIGHT OVER THE HB](fight-over-the-hb.webp "FIGHT OVER THE HB")

</details>

<details>
<summary>Footnotes for “<i>Siricidae</i>”</summary>
...
![rusa does the first stage of CWKPQ](rusa-does-the-jq-stage-of-cwkpq.webp "rusa does the first stage of CWKPQ")
...
![Cleaving CWKPQ](cwkpq-cleave.webp "Cleaving CWKPQ")
...
![food pix](food-pix.webp "food pix")

![ElonMusk](elonmusk.webp "ElonMusk")

![no you don’t, celo](no-you-don-t.webp "no you don’t, celo")

![careboo](careboo.webp "careboo")

![google how do i find faust](google-how-do-i-find-faust.webp "google how do i find faust")
