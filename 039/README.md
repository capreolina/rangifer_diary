...
<details>
<summary>rusa card-hunting~</summary>

![Red Snail card get!](rusa-red-snail-card-get.png "Red Snail card get!")

![Stump card get!](rusa-stump-card-get.png "Stump card get!")

![Dark Stump card get!](rusa-dark-stump-card-get.png "Dark Stump card get!")

![Green Mushroom card get!](rusa-green-mushroom-card-get.png "Green Mushroom card get!")

![Ribbon Pig card get!](rusa-ribbon-pig-card-get.png "Ribbon Pig card get!")

![Pig card get!](rusa-pig-card-get.png "Pig card get!")

![Octopus & Jr. Necki cards get!](rusa-octopus-and-jr.-necki-cards-get.png "Octopus & Jr. Necki cards get!")

![Bubbling card get!](rusa-bubbling-card-get.png "Bubbling card get!")

![Red tab completed~](rusa-red-tab-get.png "Red tab completed~")

Completed the first tab~ Great start~~

![Axe Stump card get!](rusa-axe-stump-card-get.png "Axe Stump card get!")

![Blue Mushroom card get!](rusa-blue-mushroom-card-get.png "Blue Mushroom card get!")

![Stirge card get!](rusa-stirge-card-get.png "Stirge card get!")

![pls gib jr. necki card ;(](pls-gib-jr.-necki-card.png "pls gib jr. necki card ;(")

_WHERE_ are the [Jr. Necki](https://maplelegends.com/lib/monster?id=2130103) cards ;(

![Horny Mushroom card get!](rusa-horny-mushroom-card-get.png "Horny Mushroom card get!")

![Zombie Mushroom card get!](rusa-zombie-mushroom-card-get.png "Zombie Mushroom card get!")
...
![Croco card get!](rusa-croco-card-get.png "Croco card get!")
...
![Awful Ravana run](awful-rav-run.png "Awful Ravana run")
...
![capre and JumpQuest vs. Capt. Lat](capre-and-jumpquest-vs-capt-lat.png "capre and JumpQuest vs. Capt. Lat")
...
![Cortical hits 70](cort-70.png "Cortical hits 70")
...
![Stone Golem card get!](capre-stone-golem-card-get.png "Stone Golem card get!")

![Mixed Stone Golem card get!](capre-mixed-stone-golem-card-get.png "Mixed Stone Golem card get!")

![Jr. Sentinel card get!](capre-jr.-sentinel-card-get.png "Jr. Sentinel card get!")

![Sentinel card get!](capre-sentinel-card-get.png "Sentinel card get!")

![Ice Sentinel card get!](capre-ice-sentinel-card-get.png "Ice Sentinel card get!")

![Leatty card get!](capre-leatty-card-get.png "Leatty card get!")

![T2 ring get!](capre-t2-ring-get.png "T2 ring get!")

YEET~

![Dark Leatty card get!](capre-dark-leatty-card-get.png "Dark Leatty card get!")

![Jr. Pepe card get!](capre-jr.-pepe-card-get.png "Jr. Pepe card get!")

![Scuba Pepe cards get!](capre-scuba-pepe-cards-get.png "Scuba Pepe cards get!")

![Ratz card get!](capre-ratz-card-get.png "Ratz card get!")

![Black Ratz card get!](capre-black-ratz-card-get.png "Black Ratz card get!")

![Chirppy card get!](capre-chirppy-card-get.png "Chirppy card get!")

![Drumming Bunny card get!](capre-drumming-bunny-card-get.png "Drumming Bunny card get!")

![Trixter card get!](capre-trixter-card-get.png "Trixter card get!")

![Green Trixter card get!](capre-green-trixter-card-get.png "Green Trixter card get!")

![Helly card get!](capre-helly-card-get.png "Helly card get!")

![Planey card get!](capre-planey-card-get.png "Planey card get!")

![Bloctopus card get!](capre-bloctopus-card-get.png "Bloctopus card get!")

![King Bloctopus card get!](capre-king-bloctopus-card-get.png "King Bloctopus card get!")
